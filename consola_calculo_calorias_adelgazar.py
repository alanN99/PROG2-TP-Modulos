...
rango = ci.consumo_calorias_recomendado_para_adelgazar(peso, altura, edad, valor_genero, valor_actividad)

print(f"Para adelgazar es recomendado que consumas entre: {rango[0]:.2f} y {rango[1]:.2f} cal al día.")